...
// import 'package:universal_io/io.dart' as universalio;
...
//           if (pdffile != null && (universalio.Platform.isIOS || universalio.Platform.isAndroid))
//             Text(
...
//                     print('geldim1');
//                     if (result != null) {
//                       if (universalio.Platform.isIOS || universalio.Platform.isAndroid) {
//                         print('geldim2');
...
//                         setState(() {
//                           print('geldim4');
//                           pdffile = html.File(bytes!, result.files.single.name);
//                         });
//                         print('geldim5');
//                       }
//
...
//               await sendEmail(
//                   ['${_patientEmailController.text}'], "Report Generated", "Report Data", urlDownload!);
//               print(urlDownload);
//             } else {
